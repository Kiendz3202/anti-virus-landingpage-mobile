		...
		<div className="h-screen bg-[#080533]">
			...
			>
				...
				<div className="bg-[#08043D] h-[40rem] w-[40rem] mx-auto rounded-full flex items-center justify-center">
					<div className=" bg-[#070446] h-[32rem] w-[32rem] rounded-full flex items-center justify-center ">
						<div className="bg-gradient-to-r from-[#0F2171] to-[#075DAF] h-[28rem] w-[28rem] rounded-full flex items-center justify-center animate-spin relative">
							<div className=" bg-gradient-to-r from-[#08042E] to-[#060075] h-[24rem] w-[24rem] rounded-full flex items-center justify-center absolute top-0">
								{/* <div
							onClick={scanHandle}
