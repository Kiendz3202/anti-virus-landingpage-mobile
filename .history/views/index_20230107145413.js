	...
	return (
		<div className="h-screen bg-[#F2F3F7]">
			...
			>
				<div>
					<img
						className="w-[15rem] h-auto mx-auto hover:cursor-pointer"
						src="/shield.jpg"
					/>
				</div>
				<div
					onClick={scanHandle}
					className={`flex items-center justify-center  text-white font-semibold mx-auto mt-[7rem] h-[7rem] text-[2.4rem] w-[35rem] rounded-full bg-[#FF9E43] active:opacity-80 cursor-pointer`}
				>
					{loadingScan ? (
