	...
	return (
		<div className="h-screen bg-[#F2F3F7]">
			...
			>
				...
				<div
					onClick={scanHandle}
					className={`flex items-center justify-center  text-black font-semibold mx-auto mt-[20rem] h-[12rem] text-[2.8rem] w-[40rem] rounded-full  shadow-xl active:opacity-80 cursor-pointer animate-bounce ${
						showResult ? 'hidden' : ''
					}`}
				>
					{loadingScan ? (
