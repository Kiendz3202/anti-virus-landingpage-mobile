...
function HomeView() {
	...
	return (
		// <div className={` w-full ${page1 ? 'h-screen' : 'h-full'} `}>
		<div
			className={` w-full transition-all ease-in-out delay-150 duration-300 h-full hover:opacity-25  `}
		>
			<div
				className={`pt-[10rem] pb-[6rem] h-full bg-[#1C58B1] hover:bg-slate-600 transition-all ease-in-out delay-150 duration-300 ${
