...
export default function Home() {
	return (
		<div className=" w-full  pb-[5rem] rounded-b-[5rem]">
			...
			<div>
				<div className="flex justify-between bg-slate-400 h-[5rem] items-center text-[2.4rem] font-medium">
					<div>
						<div className="bg-[#2A81E3] text-white rounded-full w-[5rem] h-[5rem] flex text-center align-middle">
