...
function ScanShield() {
	return (
		<div>
			<div
				className={` bg-gradient-to-r from-[#2483EA] to-[#1A58FD] h-[40rem] w-[40rem] mx-auto rounded-full flex items-center justify-center animate-bounce`}
			>
