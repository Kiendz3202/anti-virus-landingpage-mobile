...
function ScanShield() {
	return (
		<div>
			...
			>
				<div className=" bg-[#070446] h-[39.5rem] w-[39.5rem] rounded-full flex items-center justify-center relative">
					<div
						className={` bg-gradient-to-r from-[#2483EA] to-[#1A58FD] h-[35rem] w-[35rem] mx-auto rounded-full flex items-center justify-center `}
					>
						<div className=" bg-[#070446] h-[34.5rem] w-[34.5rem] rounded-full flex items-center justify-center relative"></div>
					</div>
				</div>
			</div>
		</div>
