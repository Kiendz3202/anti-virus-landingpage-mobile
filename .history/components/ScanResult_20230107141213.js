...
function ScanResult() {
	return (
		<div className="bg-[#F2F3F7]">
			{/* big file  */}
			<div className="flex justify-between  h-[10rem] items-center text-[2.4rem] font-medium active:bg-white">
				<div>
			...
			{/* Tai ung dung   */}
			<div className="flex flex-col   items-center text-[2.8rem] font-medium mt-[4rem] pb-[3rem]">
				<div className="flex items-center justify-center bg-[#FF9E43] text-white rounded-full w-[30rem] h-[8rem] active:opacity-60">
					<div>Tải xuống</div>
					<div>
						<FileDownloadIcon
							sx={{
