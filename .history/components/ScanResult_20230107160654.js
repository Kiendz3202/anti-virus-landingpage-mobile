...
function ScanResult() {
	return (
		<div className="bg-[#F2F3F7]">
			{/* big file  */}
			<div className="flex justify-between  h-[14rem] items-center text-[2.4rem] font-medium ">
				<div>
			...
			{/* diet virus  */}
			<div className="flex justify-between  h-[12rem] items-center text-[2.4rem] font-medium">
				<div>
					<div className="bg-[#2A81E3] text-white rounded-full w-[7rem] h-[7rem] ml-[2rem]">
						<BugReportIcon
							sx={{
