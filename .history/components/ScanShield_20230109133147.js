				...
				<div className=" bg-[#070446] h-[39.5rem] w-[39.5rem] rounded-full flex items-center justify-center ">
					...
					>
						<div className=" bg-[#070446] h-[34.5rem] w-[34.5rem] rounded-full flex items-center justify-center relative">
							<div className="  bg-gradient-to-r from-[#2483EA] to-[#1A58FD] h-[30rem] w-[30rem] rounded-full flex items-center justify-center animate-spin"></div>
							<div className=" bg-[#070446] h-[28rem] w-[28rem] rounded-full flex items-center justify-center absolute top-[3.1rem]">
								<img
									src="/shieldLogo.png"
									// className={`${
