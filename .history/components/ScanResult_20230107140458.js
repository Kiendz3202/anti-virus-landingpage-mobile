...
function ScanResult() {
	return (
		<div className="bg-[#F6F6FA]">
			...
			{/* Tai ung dung   */}
			<div className="flex justify-between  h-[14rem] items-center text-[2.4rem] font-medium mt-[4rem] pb-[3rem]">
				<div className="flex items-center justify-center bg-[#FF9E43] text-white rounded-full w-[30rem] h-[10rem] ">
					<div>Tải xuống</div>
					<div>
						<FileDownloadIcon
							sx={{
				...
				<div className="   break-words w-[20rem]">
