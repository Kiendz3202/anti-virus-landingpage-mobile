		...
		<div className="mt-[3rem]">
			...
			{isScanning ? (
				...
				<div className="flex flex-col   items-center text-[3.2rem] font-medium mt-[4rem] pb-[3rem]">
					<div className=" text-[2.6rem] font-semibold">
						Phát hiện {trashFile + bigFile} GB rác trên điện thoại
						của bạn, cài đặt ứng dụng An Secruity để dọn sạch hoàn
						toàn
					</div>
					<a
						target="_blank"
					...
					>
						<div className="flex items-center justify-center mt-[6rem] bg-[#FF9E43] text-white rounded-full w-[30rem] h-[8rem] active:opacity-60 cursor-pointer animate-bounce">
							<div>Tải xuống</div>
							<div>
								<FileDownloadIcon
									sx={{
